...
public class JPEGImageHandlerColors extends ImageHandler {
    ...
    public void generateFiles() throws Exception {
        //Foto Roja
        FileOutputStream FotoRoja = new FileOutputStream("salidas/Red-"+nom+".jpeg");
        for(int i=0; i<imagR.getWidth(); i++){
            for(int j=0; j<imagR.getHeight(); j++){
        ...
        //Foto Verde
        FileOutputStream FotoVerde = new FileOutputStream("salidas/Green-"+nom+".jpeg");
        ...
        //Foto Azul
        FileOutputStream FotoAzul = new FileOutputStream("salidas/Blue-"+nom+".jpeg");
        ...
        //Foto Sepia
        FileOutputStream FotoSepia = new FileOutputStream("salidas/Sepia-"+nom+".jpeg");
